...
export const CustomBottomSheet = forwardRef((propsValues: ModalProps, ref: any) => {
  const {
    ...
    if (HeadingComponent) {
      ...
      return (
        <div className="bottomsheet_heading">
          ...
          {(fullScreen || closeIcon) && <CloseOutlined onClick={onBottomSheetClose} className="bottomsheet_heading--icon" />}
        </div>
      );
    }
  };
  ...
  return (
    <BottomSheet
      ...
      ref={ref}
      snapPoints={({ maxHeight, minHeight }) => (fullScreen ? maxHeight : minHeight)}
